...
public class HolidayFilterDTO {
	...
	public String toString() {
		return "HolidayFilterDto [createDateTimeStart=" + createDateTimeStart + ", createDateTimeEnd="
				+ createDateTimeEnd + ", employeeName=" + employeeName + ", approverName=" + approverName
				+ ", approved=" + approved + ", startDate=" + startDate + ", endDate=" + endDate + "]";
	}
